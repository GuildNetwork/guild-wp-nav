...
class GuildNav_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'guild-nav'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'guild-nav'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'guild-nav') ?>"/>
                </p>
            </form>
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'guild-nav');
            case 'false':
                return __('false', 'guild-nav');

            case 'Administrator':
                return __('Administrator', 'guild-nav');
            case 'Editor':
                return __('Editor', 'guild-nav');
            case 'Author':
                return __('Author', 'guild-nav');
            case 'Contributor':
                return __('Contributor', 'guild-nav');
            case 'Subscriber':
                return __('Subscriber', 'guild-nav');
            case 'Anyone':
                return __('Anyone', 'guild-nav');
        }
        return $optionValue;
    }
